...
| 3 | Operation leases, native file broker, gateway, isolated execution, cancellation | Native broker and race suite pass on macOS and Linux; real container isolation/cancellation pass; full gateway and runtime integration evidence pending |
