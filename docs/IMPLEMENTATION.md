...
| 4 | Specialist admission, artifacts, review workflow and dependency graph | Durable assignments, host-only task claims, scoped context reuse, result lineage, revision boundaries and dependency invalidation pass; automatic contained specialist execution and full runtime-driven workflow pending |
